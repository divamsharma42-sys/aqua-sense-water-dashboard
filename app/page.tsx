...
import { generateMockSensorData, type SensorData } from "@/lib/mock-data";
    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="lg:ml-[260px] transition-all duration-300">
        ...
        <div className="p-6 space-y-6">
          ...
          <WarningBanner
            type="leakage"
            visible={sensorData.leakageDetected}
          />
          <WarningBanner
            type="quality"
            visible={sensorData.qualityStatus === "Unsafe"}
          />
          <WarningBanner
            type="lowLevel"
            visible={sensorData.waterLevel < 20}
          />
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <DashboardCard
              ...
              action={
                ...
                >
                  {getTankStatus(sensorData.waterLevel)}
                </span>
              }
            >
              <TankVisualization
                level={sensorData.waterLevel}
                status={getTankStatus(sensorData.waterLevel)}
              />
            </DashboardCard>
            ...
            <DashboardCard
              title="Water Quality"
              subtitle="TDS & Turbidity analysis"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <SensorCard
              ...
              description="TDS Sensor"
              trend={sensorData.tds > 300 ? "up" : "stable"}
            />
            <SensorCard
              title="Turbidity"
              value={sensorData.turbidity}
              ...
              icon="activity"
              status={
                sensorData.turbidity > 7
                  ? "danger"
                  : sensorData.turbidity > 4
                  ? "warning"
                  : "normal"
              }
            ...
            <SensorCard
              ...
              icon="thermometer"
              status={
                sensorData.leakageDetected
                  ? "danger"
                  : sensorData.flowRate > 15
                  ? "warning"
                  : "normal"
              }
              description="Flow Sensor"
              trend={sensorData.leakageDetected ? "up" : "stable"}
            />
          </div>
          ...
          <DashboardCard
            ...
            subtitle="Overall health of your water management system"
          >
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              <div
                className={`p-4 rounded-xl ${
                  sensorData.qualityStatus === "Safe"
                    ? "bg-emerald-500/10 border border-emerald-500/30"
                    : sensorData.qualityStatus === "Moderate"
              ...
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  >
                    Water Quality: {sensorData.qualityStatus}
                  </span>
                </div>
                <p className="text-xs text-slate-400">
                  {sensorData.qualityStatus === "Safe"
              ...
              >
                ...
                <p className="text-xs text-slate-400">
                  {sensorData.leakageDetected
                    ? "Abnormal flow pattern detected"
                    : "Flow patterns are normal"}
                </p>
              </div>
            </div>
          </DashboardCard>
